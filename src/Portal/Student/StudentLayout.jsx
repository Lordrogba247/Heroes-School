...
const navItems = [
    ...
    },
    {
        ...
        path: "/portal/student/online-classes",
        icon: (
        ...
        <div className="stl-root">
            ...
            <header className="stl-topbar">
                <div className="stl-topbar-left">
                    ...
                    <NavLink to="/" className="stl-brand">
                        <img src={logo} alt="Heroes College" className="stl-brand-logo" />
                        <div className="stl-brand-titles">
                            <span className="stl-brand-name">Heroes College</span>
                            <span className="stl-brand-sub">&amp; Primary School</span>
                        </div>
                    </NavLink>
                </div>

                <div className="stl-topbar-right">
                    <div className="stl-user">
                        <div className="stl-avatar">{student.initials}</div>
                        <div className="stl-user-info">
                            <span className="stl-user-name">{student.name}</span>
                            <span className="stl-user-class">{student.class}</span>
                        </div>
                    </div>
                    <button className="stl-logout" onClick={handleLogout}>
            ...
            <div className="stl-body">
                ...
                <aside className={`stl-sidebar ${sidebarOpen ? "stl-sidebar--open" : ""}`}>
                    <nav className="stl-nav">
                        {navItems.map((item) => (
                            <NavLink
                                ...
                                to={item.path}
                                className={({ isActive }) =>
                                    `stl-nav-item ${isActive ? "stl-nav-item--active" : ""}`
                                }
                                onClick={() => setSidebarOpen(false)}
                            >
                                <span className="stl-nav-icon">{item.icon}</span>
                                <span className="stl-nav-label">{item.label}</span>
                            </NavLink>
                        ))}
                    </nav>
                </aside>

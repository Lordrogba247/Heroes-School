...
export default function AdminDashboard() {
    ...
    const [recentAssignment, setRecentAssignment] = useState(null);
    const [recentCbt, setRecentCbt] = useState(null);
    ...
    if (loading) return (
        <div className="ad-page">
            <p style={{ color: "#888", fontFamily: "Poppins, sans-serif", fontSize: 14 }}>Loading...</p>
        </div>
    );

    return (
        <div className="ad-page">
            <h1 className="ad-title">Welcome, {firstName}</h1>
                    ...
                    <div className="ad-card-body">
                        {recentAssignment ? (
                            <div className="ad-list-item">
                                ...
                                <span className={`ad-badge ad-badge--${recentAssignment.status?.toLowerCase() === "active" ? "active" : "expired"}`}>
                                    {recentAssignment.status}
                                </span>
                            </div>
                        ) : (
                            <p style={{ fontSize: 13, color: "#999", fontFamily: "Poppins", margin: "0 0 16px" }}>No assignments yet.</p>
                        )}
                    ...
                    <div className="ad-card-body">
                        {recentCbt ? (
                            <div className="ad-list-item">
                                ...
                                <span className={`ad-badge ad-badge--${recentCbt.status?.toLowerCase() === "active" ? "active" : "expired"}`}>
                                    {recentCbt.status}
                                </span>
                            </div>
                        ) : (
                            <p style={{ fontSize: 13, color: "#999", fontFamily: "Poppins", margin: "0 0 16px" }}>No CBT tests yet.</p>
                        )}
